...
// */
//public class BacktrackSolverSimulator extends AbstractSolver{
//
//    /**
//     * Constructeur
...
//     */
//    public BacktrackSolverSimulator(Set<Variable> variables, Set<Constraint> constraints){
...
//     * @return
//     */
//    public Map<Variable, Object> sra(Map<Variable, Object> map, Queue<Variable> pile, Map<Variable, Object> forbiddenMap){
...
//                //newPile.remove(v);
//                newMap = this.sra(newMap, newPile, forbiddenMap);
//                if(newMap != null){
//                    return newMap;
//                }
//            }
...
//    }
//
//    public boolean mapAreEqual(Map<Variable, Object> map, Map<Variable, Object> map2){
